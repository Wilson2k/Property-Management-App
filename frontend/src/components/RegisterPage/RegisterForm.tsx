                    ...
                    <Form className="card-body p-5 text-center" onSubmit={handleSubmit(FormSubmit)}>
                        <div className="mb-md-5">
                            ...
                            <div className="form-outline form-white mb-4">
                                ...
                                <Form.Control disabled={isLoading} type="fname" id="typefnameX" className="form-control form-control-lg" placeholder={"Enter your first name"}
                                    {...register('firstName')} />
                            </div>

                            <div className="form-outline form-white mb-4">
                                <Form.Label>Last Name</Form.Label>
                                <Form.Control disabled={isLoading} type="lname" id="typelnameX" className="form-control form-control-lg" placeholder={"Enter your last name"}
                                    {...register('lastName')} />
                            </div>
                            ...
                            {response === 409 ?  <div className="card bg-danger">Email taken</div> : <></>}
                            {response === 500 ?  <div className="card bg-danger">Error registering</div> : <></>}
                            {response === 200 ?  <div className="card bg-success">Successfully Registered</div> : <></>}
                            
                            <button className="btn btn-outline-light btn-lg px-5 mt-4" type="submit" disabled={isLoading}>
