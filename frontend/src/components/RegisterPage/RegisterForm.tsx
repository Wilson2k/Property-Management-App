                    ...
                    <div className="card-body p-5 text-center">
                        <div className="mb-md-5">
                            ...
                            <div className="form-outline form-white mb-4">
                                ...
                                <Form.Control type="fname" id="typefnameX" className="form-control form-control-lg" placeholder={"Enter your first name"} />
                            </div>

                            <div className="form-outline form-white mb-4">
                                <Form.Label>Last Name</Form.Label>
                                <Form.Control type="lname" id="typelnameX" className="form-control form-control-lg" placeholder={"Enter your last name"} />
                            </div>
                            ...
                            <button className="btn btn-outline-light btn-lg px-5 mt-4" type="submit">Register</button>
                        </div>
