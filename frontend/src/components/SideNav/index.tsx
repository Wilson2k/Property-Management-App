...
export default function SideNav(props: NavBarProps) {
    ...
    return (
        <Col className="px-0" xs='auto' style={{width: isDesktopOrLaptop ? 300 : 'auto'}} >
            <Nav activeKey={active} variant="pills" defaultActiveKey="/" className="flex-column" style={{ background: '#19376D', minHeight: '100vh', padding: 0 }}>
                ...
                <Nav.Link className="mt-auto" style={{ color: 'white', display: 'flex', margin: 10 }} onClick={FormSubmit}>
