...
export default function SideNav(props: NavBarProps) {
  ...
  return (
    <Col
      className="px-0"
      lg="auto"
      style={{ width: isDesktopOrLaptop ? '20%' : 'auto', maxWidth: '350px' }}
    >
      <Nav
        activeKey={active}
        variant="pills"
        ...
        style={{
          background: '#19376D',
          minHeight: '100vh',
          paddingInline: isDesktopOrLaptop ? 20 : 10,
        }}
      >
        <Navbar.Brand
          href="/"
        ...
        >
          <i
            ...
            style={{ marginRight: isDesktopOrLaptop ? 20 : 0 }}
          ></i>
          {isDesktopOrLaptop && <>HouseConnect</>}
        </Navbar.Brand>
        <Nav.Link
          style={{ color: 'white', marginBlock: 20, display: 'flex' }}
          href="/dashboard"
        >
          <i
        ...
        <Nav.Link
          className="mt-auto"
          style={{ color: 'white', display: 'flex', marginBlock: 20 }}
          onClick={() => void FormSubmit()}
        >
          <i
