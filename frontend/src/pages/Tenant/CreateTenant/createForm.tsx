...
export default function CreateTenantForm(props: {
  data: TenantTypes.TenantCreateContext;
}) {
      ...
      <Container fluid style={{ maxWidth: '1000px' }}>
        ...
        >
          <div className="mb-md-5">
            ...
            {response === 409 ? (
              <div className="card bg-danger">Tenant already exists</div>
            ) : (
              <></>
            )}
            {response === 500 ? (
              <div className="card bg-danger">Error creating tenant</div>
            ) : (
              <></>
            )}
            {response === 200 ? (
              <div className="card bg-success">Successfully created tenant</div>
            ) : (
              <></>
            )}
