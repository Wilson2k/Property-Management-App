        ...
        <div className="card bg-dark text-white" style={{ borderRadius: '1rem' }}>
          ...
          >
            <div className="mb-md-5">
              ...
              {response === 404 ? (
                <div className="card bg-danger">Account not found</div>
              ) : (
                <></>
              )}
              {response === 400 ? (
                <div className="card bg-danger">Incorrect password</div>
              ) : (
                <></>
              )}
              {response === 500 ? (
                <div className="card bg-danger">Error logging in</div>
              ) : (
                <></>
              )}
              {response === 200 ? (
                <div className="card bg-success">Successfully Logged In</div>
              ) : (
                <></>
              )}
