...
export default function EditPropertyPage() {
    ...
    return <UpdateForm id={propertyId} oldData={defaultUpdateProperty} />
}

function UpdateForm(props: {id: number, oldData: PropertyTypes.PropertyUpdateInput}) {
    ...
    const { mutateAsync } = useMutation({
        mutationFn: (property: PropertyTypes.PropertyUpdateInput) => updateProperty(props.id, property),
        onSettled: () => {
            setLoading(false);
        },
    });
                    ...
                    <Container fluid style={{ maxWidth: '1000px' }}>
                        <Form className="card-body p-5 text-center" onSubmit={handleSubmit(FormSubmit)}>
                            <div className="mb-md-5">
                                ...
                                {response === 500 ? <div className="card bg-danger">Error updating property</div> : <></>}
