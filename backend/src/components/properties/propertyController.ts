...
import { PropertyContext, PropertyCreateContext } from './property';
...
const getAllUserOpenTicketProperties = (req: CustomRequest<PropertyContext>, res: Response) => {
    (async () => {
        const ownerContext: PropertyContext = {
            ownerId: req.body.ownerId,
        };
...
// Get all properties owned by user of specific type
const getUserPropertiesByTenant = (req: CustomRequest<PropertyContext>, res: Response) => {
    (async () => {
        const propertyContext: PropertyContext = {
            type: req.body.type,
            ownerId: req.body.ownerId,
...
export {
    getAllProperties, getAllUserOpenTicketProperties, getAllUserProperties, getPropertyByAddress,
    getPropertyById, getUserPropertiesByCity, getUserPropertiesByState, getUserPropertiesByTenant,
    getUserPropertiesByType, createNewUserProperty,
}